###--------------------------------------------------------------------------###
###------------------ Forecast code for conjugate VARs ----------------------###
###--------------------------------------------------------------------------###
# 1.) Non-informative prior 
# 2.) Symmetric Minnesota prior
# 3.) Asymmetric Minnesota prior
# 4.) Subspace Shrinkage 
...
source(paste0(func.dir, "conjVARstd_func.R"))
source(paste0(func.dir, "conjVARasym_func.R"))
...
grid.conj   <- c("conjVAR-FLAT",
                 "conjVAR-MINo",
                 "conjVAR-MINg",
                 "conjVAR-ASYMo",
                 "conjVAR-ASYMg")

grid.conj <- "conjVAR-ASYMg"
